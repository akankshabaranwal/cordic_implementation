...
HD_PWD='/home/sonal/Desktop/vlsi-arch/project/cordic_implementation/cordic_pipeline/cordic_pipeline.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log cordic_tb_updated.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source cordic_tb_updated.tcl -notrace

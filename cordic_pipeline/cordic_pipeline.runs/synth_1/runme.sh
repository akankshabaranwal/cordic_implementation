...
HD_PWD='/home/sonal/Desktop/vlsi-arch/project/cordic_implementation/cordic_pipeline/cordic_pipeline.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log cordic_tb_updated.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source cordic_tb_updated.tcl
